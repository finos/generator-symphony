...
module.exports = class extends Generator {
  prompting() {
	...
	/*
	 * TODO add a check for the latest verison
	 * of the python SDK
	 * TODO update version, and log update
	 *
	 *TODO remove sample bot options that are not
	 *TODO build additional samples
	 *TODO change order of tpl check to match jav
 	*/
